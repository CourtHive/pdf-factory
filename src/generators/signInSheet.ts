...
export function generateSignInSheetPDF(players: ParticipantRow[], options: SignInSheetOptions = {}): jsPDF {
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      index: { cellWidth: 8, halign: 'center' },
      name: { cellWidth: 'auto', fontStyle: 'bold' },
      nationality: { cellWidth: 12, halign: 'center' },
      ranking: { cellWidth: 12, halign: 'center' },
      seed: { cellWidth: 10, halign: 'center' },
      entry: { cellWidth: 12, halign: 'center' },
