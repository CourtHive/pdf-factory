...
describe.skipIf(!hasReferenceFixtures)('PDF Extractor', () => {
...
describe.skipIf(!hasReferenceFixtures)('Text Analyzer', () => {
...
describe.skipIf(!hasReferenceFixtures)('Coordinate Clustering', () => {
